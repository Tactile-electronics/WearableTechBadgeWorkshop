...
while True:
    ...
    print(button_green_1)
    print(button_red_1)
    print(button_green_2)
    print(button_red_2)

    if button_green_1 and button_red_1 and not button_green_2 and not button_red_2:
        level = 0
    elif button_green_1 and not button_green_2 and level < 7:
        level += 1
    elif button_red_1 and not button_red_2 and level > -7:
        level -= 1
